...
### 3. 🤖 AI-Powered Business Insights (RAG Architecture)
...
* **Automated Reporting:** Calls the `gemini-flash-latest` model to synthesize the data and knowledge base into a comprehensive, markdown-formatted business commentary.
...
Affiliates_Analysis/
│
├── aff_dashboard_4.py       # Main Streamlit application entry point (UI & Routing)
...
(Core dependencies include: streamlit, pandas, plotly, google-generativeai, python-dotenv, chromadb)
...
streamlit run aff_dashboard_4.py

Data Upload & Management:

Navigate to the "Data Upload" section on the left sidebar.

Drag and drop your monthly .csv files.

The system will save new files to uploaded_monthly_data/ and automatically merge them into the active dashboard.
